...
from backend.python.menteur.M_LaunchGames import M_LaunchGames
from backend.python.menteur.player.M_APlayer import M_APlayer
from backend.python.menteur.player.M_Player import M_Player
...
from backend.python.menteur.player.M_IA import M_IA
